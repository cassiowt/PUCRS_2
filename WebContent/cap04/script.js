 ...
 * @date 16/07/2015
 * 
 * Função que monta a resposta  na pagina de cadastro
 * Concatenando os dados cadastrais em uma
 * frase.
 */
function montaResposta() {
	queryUrl = getUrlVars();  // executa a função getUrlVars() criando um array com os parâmetros
    ...
    if (typeof(fLazer) != "undefined") {lazer += fLazer;}
    if (typeof(fLazer1) != "undefined") {lazer += ","+fLazer1;}
    if (typeof(fLazer2) != "undefined") {lazer += ","+fLazer2;}
    if (lazer == " e gosta de ") {lazer = "";}
    
    var fTexto = saudacao  + fNome +" "+ fSobrenome + " é do sexo " + fSexo + lazer;
